	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				$data['text_greeting'] = sprintf($language->get('text_new_greeting'), $order_info['payment_lastname'], date($language->get('date_format_short'), strtotime($order_info['date_added'])));
				...
				$data['text_footer'] = sprintf($language->get('text_confirm_footer'), $order_id);
				...
				$text .= sprintf($language->get('text_confirm_footer'), $order_id) . "\n\n";
